...
The goal of `{iobed.model}` is to provide functions, utilities and models to classify person movement on a smart bed basted on weight sensors under the bed..

## Installation

You can install the development version of iobed.model from [GitHub](https://github.com/) with:
...
Please note that the iobed.model project is released with a [Contributor Code of Conduct](https://contributor-covenant.org/version/2/1/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
